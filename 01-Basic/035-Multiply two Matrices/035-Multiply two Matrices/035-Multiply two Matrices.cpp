...
/*
	...
	To understand this example, you should have the knowledge of following C++ programming topics:
		...
		Passing Array to a Function in C++ Programming(https://www.programiz.com/cpp-programming/passing-arrays-function)

	This program asks user to enter the size of the matrix (rows and columns).
	Then, it asks the user to enter the elements of two matrices and 
	finally it multiplies two matrix and displays the result.
*/
...
void multiplyMatrices(	int firstMatrix[][10], int secondMatrix[][10], 
						int multResult[][10], int rowFirst, int columnFirst, int rowSecond, 
						int columnSecond);
